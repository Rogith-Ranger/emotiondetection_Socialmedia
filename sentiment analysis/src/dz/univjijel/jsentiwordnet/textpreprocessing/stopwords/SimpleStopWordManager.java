 ...
 * MA 02110-1301  USA
 */
package dz.univjijel.jsentiwordnet.textpreprocessing.stopwords;
 ...
 */
public class SimpleStopWordManager implements StopWordManager {
    
    private final String[] enStopWords = {"a", "about", "above", "above", "across", "after", "afterwards", "again", "against",
   ...
   "the"};
    ...
    @Override
    public boolean isAStopWord(String term) {
        return Arrays.asList(enStopWords).contains(term);
    }
